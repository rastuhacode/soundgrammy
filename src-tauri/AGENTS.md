...
| `src/session.rs` | Encrypted ferogram `SessionBackend` + platform credential store |
| `src/android_keyring.rs` | Android Keystore-backed credential store initialization |
