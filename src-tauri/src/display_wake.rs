...
mod platform {
    ...
    /// Mobile placeholder until a native display wake implementation is added.
    pub struct DisplayWakeState;
    ...
    impl DisplayWakeState {
        ...
        pub fn set_enabled(&self, _enabled: bool) -> AppResult<()> {
            Ok(())
        }
    }
}

pub use platform::DisplayWakeState;
